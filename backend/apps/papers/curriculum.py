# RTU Curriculum Data
# Rajasthan Technical University (RTU) Curriculum Structure
...
# RBSE and CBSE - Standard classes
RBSE_CBSE_CLASSES = {
    'Class 6': 'Class 6',
    'Class 7': 'Class 7',
    'Class 8': 'Class 8',
...
RBSE_CBSE_SUBJECTS = {
    'Class 6': ['Mathematics', 'Science', 'Hindi', 'English', 'Social Science'],
    'Class 7': ['Mathematics', 'Science', 'Hindi', 'English', 'Social Science'],
    'Class 8': ['Mathematics', 'Science', 'Hindi', 'English', 'Social Science'],
    'Class 9': ['Mathematics', 'Science', 'Hindi', 'English', 'Social Science'],
    'Class 10': ['Mathematics', 'Science', 'Hindi', 'English', 'Social Science'],
    'Class 11': ['Mathematics', 'Physics', 'Chemistry', 'Biology', 'Computer Science', 'English', 'Hindi'],
    'Class 12': ['Mathematics', 'Physics', 'Chemistry', 'Biology', 'Computer Science', 'English', 'Hindi'],
}
